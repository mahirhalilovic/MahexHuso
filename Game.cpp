...
Game::Game(HWND hwnd) : m_hwnd{hwnd} {
    Mahex = Player{0, 0,
                   (HBITMAP) LoadImage(NULL, "assets/images/mahex.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE),
                   (HBITMAP) LoadImage(NULL, "assets/images/mahex_mask.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE),
                   0.f, 0.f, true, 0, IDLE};
    Huso = Player{0, 0,
                   (HBITMAP) LoadImage(NULL, "assets/images/huso.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE),
                   (HBITMAP) LoadImage(NULL, "assets/images/huso_mask.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE),
                   0.f, 0.f, true, 0, IDLE};

    char buffer[MAX_PATH];
    GetCurrentDirectory(MAX_PATH, buffer);
    m_currentWorkingDirectory = std::string(buffer);
    ...
    if(!LoadSettings()) {
        MessageBox(m_hwnd, "Settings could not have been loaded.", "Error", MB_OK);
...
void Game::ConstructButtons() {
    buttonBack = Button(950, 620, 200, 50, "BACK");
    buttonBack.SetFont("i pixel u", 26, false);

    buttonMainMenuPlay = Button(500, 235, 200, 50, "PLAY");
    buttonMainMenuOptions = Button(500, 335, 200, 50, "OPTIONS");
    buttonMainMenuExit = Button(500, 435, 200, 50, "EXIT");
    buttonMainMenuPlay.SetFont("i pixel u", 26, false);
    buttonMainMenuOptions.SetFont("i pixel u", 26, false);
    buttonMainMenuExit.SetFont("i pixel u", 26, false);

    buttonPlayMenuGameLevels = Button(500, 235, 200, 50, "GAME LEVELS");
    buttonPlayMenuCustomLevels = Button(500, 335, 200, 50, "CUSTOM LEVELS");
    buttonPlayMenuGameLevels.SetFont("i pixel u", 26, false);
    buttonPlayMenuCustomLevels.SetFont("i pixel u", 26, false);

    buttonGameLevelsNext = Button(950, 335, 200, 50, "NEXT");
    buttonGameLevelsPrevious = Button(50, 335, 200, 50, "PREVIOUS");
    buttonGameLevelsPlay = Button(500, 560, 200, 50, "PLAY");
    buttonGameLevelsNext.SetFont("i pixel u", 26, false);
    buttonGameLevelsPrevious.SetFont("i pixel u", 26, false);
    buttonGameLevelsPlay.SetFont("i pixel u", 26, false);

    buttonCustomLevelsPlay = Button(450, 235, 300, 50, "PLAY CUSTOM LEVEL");
    buttonCustomLevelsEdit = Button(450, 335, 300, 50, "CREATE CUSTOM LEVEL");
    buttonCustomLevelsPlay.SetFont("i pixel u", 26, false);
    buttonCustomLevelsEdit.SetFont("i pixel u", 26, false);

    buttonPauseMenuResume = Button(0, 0, 200, 50, "RESUME");
    buttonPauseMenuRestart = Button(0, 0, 200, 50, "RESTART");
    buttonPauseMenuOptions = Button(0, 0, 200, 50, "OPTIONS");
    buttonPauseMenuQuit = Button(0, 0, 200, 50, "QUIT");
    buttonPauseMenuResume.SetFont("i pixel u", 26, false);
    buttonPauseMenuRestart.SetFont("i pixel u", 26, false);
    buttonPauseMenuOptions.SetFont("i pixel u", 26, false);
    buttonPauseMenuQuit.SetFont("i pixel u", 26, false);

    buttonGameWinNext = Button(0, 0, 200, 50, "NEXT");
    buttonGameWinRestart = Button(0, 0, 200, 50, "RESTART");
    buttonGameWinQuit = Button(0, 0, 200, 50, "QUIT");
    buttonGameWinNext.SetFont("i pixel u", 26, false);
    buttonGameWinRestart.SetFont("i pixel u", 26, false);
    buttonGameWinQuit.SetFont("i pixel u", 26, false);

    buttonGameOverRestart = Button(0, 0, 200, 50, "RESTART");
    buttonGameOverQuit = Button(0, 0, 200, 50, "QUIT");
    buttonGameOverRestart.SetFont("i pixel u", 26, false);
    buttonGameOverQuit.SetFont("i pixel u", 26, false);

    buttonOptionsMusic = Button(450, 285, 300, 50, "MUSIC: ON");
    buttonOptionsSoundEffects = Button(450, 385, 300, 50, "SOUND EFFECTS: ON");
    buttonOptionsMusic.SetFont("i pixel u", 26, false);
    buttonOptionsSoundEffects.SetFont("i pixel u", 26, false);

    if(!musicEnabled) buttonOptionsMusic.SetText("MUSIC: OFF");
    if(!soundEffectsEnabled) buttonOptionsSoundEffects.SetText("SOUND EFFECTS: OFF");
}
...
void Game::ConstructLabels() {
    m_label = Label(350, 50, 500, 100, "MAHEX&&HUSO");
    m_label.SetFont("i pixel u", 72, false);

    labelGameLevelsLevel = Label(300, 50, 600, 32, "");
    labelGameLevelsScore = Label(300, 85, 600, 32, "");
    labelGameLevelsLevel.SetFont("i pixel u", 28, false);
    labelGameLevelsScore.SetFont("i pixel u", 28, false);

    labelGameWinScore = Label(0, 0, 200, 40, "");
    labelGameWinHighScore = Label(0, 0, 200, 40, "");
    labelGameWinScore.SetFont("i pixel u", 24, false);
    labelGameWinHighScore.SetFont("i pixel u", 24, false);

    labelGameOver = Label(0, 0, 200, 50, "GAME OVER!!");
    labelGameOver.SetFont("i pixel u", 24, false);
}

void Game::LoadBitmaps() {
    m_backgroundMainMenu = (HBITMAP) LoadImage(NULL, "assets/images/background_mainmenu.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_backgroundMaskMainMenu = (HBITMAP) LoadImage(NULL, "assets/images/background_mask_mainmenu.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_backgroundPauseMenu = (HBITMAP) LoadImage(NULL, "assets/images/background_pausemenu.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_backgroundMaskPauseMenu = (HBITMAP) LoadImage(NULL, "assets/images/background_mask_pausemenu.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    m_bitmapLevelOne = (HBITMAP) LoadImage(NULL, "assets/level_images/level1.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_bitmapLevelTwo = (HBITMAP) LoadImage(NULL, "assets/level_images/level2.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_bitmapLevelThree = (HBITMAP) LoadImage(NULL, "assets/level_images/level3.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_bitmapLevelFour = (HBITMAP) LoadImage(NULL, "assets/level_images/level4.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    m_bitmapLevelFive = (HBITMAP) LoadImage(NULL, "assets/level_images/level5.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
}

void Game::LoadSounds() {
    m_soundManager.PreloadSound("background", m_currentWorkingDirectory + "/assets/sounds/background.wav");
    m_soundManager.PreloadSound("click", m_currentWorkingDirectory + "/assets/sounds/click.wav");
    m_soundManager.PreloadSound("coin", m_currentWorkingDirectory + "/assets/sounds/coin.wav");
    m_soundManager.PreloadSound("gameover", m_currentWorkingDirectory + "/assets/sounds/gameover.wav");
    m_soundManager.PreloadSound("gamestart", m_currentWorkingDirectory + "/assets/sounds/gamestart.wav");
    m_soundManager.PreloadSound("gamewin", m_currentWorkingDirectory + "/assets/sounds/gamewin.wav");
    m_soundManager.PreloadSound("jump", m_currentWorkingDirectory + "/assets/sounds/jump.wav");
}
...
void Game::UpdatePlayer(Player &player) {
    ...
    for(Tile& tile : m_levels[m_currentLevel - 1].m_tiles) {
        ...
        if(tile.m_type == TileType::COIN) {
                RECT intersect;
                RECT coinCheck = {tile.m_posX + 16, tile.m_posY + 16, tile.m_posX + 32, tile.m_posY + 32};
                if(IntersectRect(&intersect, &nextRect, &coinCheck)) {
                    tile.m_active = true;
    ...
    switch(m_state) {
        ...
        case GameState::PLAY_MENU:
            if(buttonPlayMenuGameLevels.IsMouseOver(mousePos.x, mousePos.y)) {
                ...
                std::string level = "LEVEL: " + std::to_string(m_currentLevel);
                labelGameLevelsLevel.SetText(level);

                if(m_finishedLevels[m_currentLevel - 1]) {
                    std::string str = "SCORE: " + std::to_string(m_finishedLevelsScores[m_currentLevel - 1]);
                    labelGameLevelsScore.SetText(str);
                } else {
                    labelGameLevelsScore.SetText("YOU HAVE NOT FINISHED THIS LEVEL YET!");
                }
        ...
        case GameState::GAME_LEVELS:
            if(buttonGameLevelsNext.IsMouseOver(mousePos.x, mousePos.y)) {
                ...
                if(m_finishedLevels[m_currentLevel - 1]) {
                    std::string score = "SCORE: " + std::to_string(m_finishedLevelsScores[m_currentLevel - 1]);
        ...
        case GameState::OPTIONS:
            if(buttonOptionsMusic.IsMouseOver(mousePos.x, mousePos.y)) {
                ...
                if(musicEnabled) {
                    buttonOptionsMusic.SetText("MUSIC: ON");
                    m_soundManager.PlayBackgroundMusic();
                } else {
                    buttonOptionsMusic.SetText("MUSIC: OFF");
                    m_soundManager.StopBackgroundMusic();
                }
                ...
                if(soundEffectsEnabled) {
                    buttonOptionsSoundEffects.SetText("SOUND EFFECTS: ON");
                } else {
                    buttonOptionsSoundEffects.SetText("SOUND EFFECTS: OFF");
                }
            } else if(buttonBack.IsMouseOver(mousePos.x, mousePos.y)) {
                if(levelInProgress) {
...
void Game::LoadLevel(int newLevel) {
    if(newLevel == 6) {
        ...
        if(GetOpenFileNameA(&ofn)) {
            ...
            MessageBox(m_hwnd, "Could not load custom level", "Error", MB_OK | MB_ICONWARNING);
        }

        if(!LoadLevelFromJSON(customLevelPath, 5)) MessageBox(m_hwnd, "Could not load level from JSON!", "Error", MB_OK);
    ...
    if(mahexEnd && husoEnd) {
        ...
        if(m_currentLevel < 6) {
            ...
            if(m_score > m_finishedLevelsScores[m_currentLevel - 1]) {
                ...
                labelGameWinHighScore.SetText("NEW HIGH SCORE!");
            } else {
                std::string score = "HIGH SCORE: " + std::to_string(m_finishedLevelsScores[m_currentLevel - 1]);
...
bool Game::LoadLevelFromJSON(std::string path, int id) {
    try {
        ...
        if(!file.is_open()) {
            MessageBox(NULL, "Could not open JSON file", "Error", MB_OK | MB_ICONERROR);
            return false;
        }
        ...
        for(const auto& tileData : levelData["tiles"]) {
            TileType type = m_levelEditor.StringToTileType(tileData["type"].get<std::string>());
            if(type == TileType::MAHEX_START) {
                m_loadedLevel.m_startMahex.x = tileData["x"].get<int>();
                m_loadedLevel.m_startMahex.y = tileData["y"].get<int>();
            } else if(type == TileType::HUSO_START) {
                m_loadedLevel.m_startHuso.x = tileData["x"].get<int>();
                m_loadedLevel.m_startHuso.y = tileData["y"].get<int>();
            } else if(type == TileType::MAHEX_END) {
                m_mahexEnd.x = tileData["x"].get<int>();
                m_mahexEnd.y = tileData["y"].get<int>();
                m_loadedLevel.m_tiles.push_back(LoadTile(tileData));
            } else if(type == TileType::HUSO_END) {
                m_husoEnd.x = tileData["x"].get<int>();
                m_husoEnd.y = tileData["y"].get<int>();
                m_loadedLevel.m_tiles.push_back(LoadTile(tileData));
            } else {
                m_loadedLevel.m_tiles.push_back(LoadTile(tileData));
            }
...
Tile Game::LoadTile(const json &tileData) {
    ...
    newTile.m_posX = tileData["x"].get<int>();
    newTile.m_posY = tileData["y"].get<int>();
    newTile.m_type = m_levelEditor.StringToTileType(tileData["type"].get<std::string>());
    ...
    switch(newTile.m_type) {
        ...
        case TileType::KEYDOWN_BLOCK:
        case TileType::PRESSURE_BLOCK:
            newTile.m_id = tileData["id"].get<int>();
            break;

        case TileType::KEYDOWN_PLATE:
            newTile.m_id = tileData["id"].get<int>();
            newTile.m_orientation = m_levelEditor.StringToOrientation(tileData["orientation"].get<std::string>());
            break;

        case TileType::PRESSURE_PLATE_START:
            newTile.m_id = tileData["id"].get<int>();
            newTile.m_orientation = m_levelEditor.StringToOrientation(tileData["orientation"].get<std::string>());
            newTile.m_startPos = tileData["startPos"].get<int>();
            newTile.m_endPos = tileData["endPos"].get<int>();
            newTile.m_movement = m_levelEditor.StringToOrientation(tileData["movement"].get<std::string>());
            break;
    }
...
bool Game::LoadSettings() {
    try {
        ...
        for(int i = 1; i <= 5; ++i) {
            ...
            m_finishedLevels[i - 1] = settings["levels"][key]["finished"].get<bool>();
            m_finishedLevelsScores[i - 1] = settings["levels"][key]["highscore"].get<int>();

            if(m_finishedLevels[i - 1]) ++m_numOfFinishedLevels;
        }

        musicEnabled = settings["music"].get<bool>();
        soundEffectsEnabled = settings["soundEffects"].get<bool>();
